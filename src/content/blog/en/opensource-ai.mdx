...
OpenScholar and DR Tulu-8B make one thing crystal clear. Size isn't everything. Small models fine-tuned for specific domains beat giants. AT&T's Chief Data Officer Andy Markus said it: "Fine-tuned SLMs will be the big trend in 2026."
...
3. Small models fight back – DR Tulu-8B (8B params) matches OpenAI Deep Research; fine-tuned SLMs are the future
