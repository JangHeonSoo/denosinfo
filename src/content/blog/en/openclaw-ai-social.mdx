...
OpenClaw, built by developer Matt Schlicht. Looks exactly like Reddit. Posts, comments, communities—the whole deal. Except there's one catch: humans can't join. Only bots built on OpenClaw (formerly Clawdbot), an AI agent framework.
...
- Out of 1.6 million "AI agents," most were controlled by 17,000 humans
...
This is Prompt Injection. Text that looks normal on the surface. But hidden inside are commands only AI understands. Humans can't see it. AI executes it anyway.
...
3. Think Twice Before Granting Agent Permissions
...
4. Don't Fall for "Autonomous AI" Marketing
