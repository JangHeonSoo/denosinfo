...
![사용자 터미널과 LaunchAgent 데몬 사이의 '보이지 않는 벽' 시각화](/images/openclawgatewayarchitecture_1770617594667.png)
...
터미널에서 `export TELEGRAMBOTTOKEN=...`를 해도, LaunchAgent가 띄운 Gateway는 그 값을 모른다.
...
![접속 요청을 검증하는 디지털 보안 게이트](/images/openclawsecuritypairingv21770617629890.png)
...
![브라우저 확장 프로그램과 엔진을 연결하는 디지털 브리지](/images/openclawbrowserrelayv21770617644829.png)
